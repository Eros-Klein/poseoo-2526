...
try
{
    ...
    var importer = host.Services.GetRequiredService<IToDoImporter>();
...
static void ConfigureServices(IServiceCollection services, IConfiguration configuration)
{
    ...
    services.AddScoped<IToDoTextParser, ToDoTextParser>();
    services.AddScoped<IToDoDatabaseWriter, ToDoDatabaseWriter>();
    services.AddScoped<IToDoImporter, ToDoImporter>();
}
