...
try
{
    ...
    var importer = host.Services.GetRequiredService<IGrammyImporter>();
...
static void ConfigureServices(IServiceCollection services, IConfiguration configuration)
{
    ...
    services.AddScoped<IGrammyStageParser, GrammyStageParser>();
    services.AddScoped<IGrammyImportDatabaseWriter, GrammyImportDatabaseWriter>();
    services.AddScoped<IGrammyImporter, GrammyImporter>();
}
