...
import { CustomerListElement } from "../customer-list-element/customer-list-element";

@Component({
  selector: 'app-customer-list-inline-edit',
  imports: [CustomerListElement],
  templateUrl: './customer-list-inline-edit.html',
  styleUrl: './customer-list-inline-edit.css',
})
export class CustomerListInlineEdit {
